...
visualize_graph <- function(mygraph, filename="graph",directed=FALSE)
{
  ...
  #### Write this graph to a gephi file
  ...
  write.gexf(nodes = nodes_df, edges = edges_df, nodesAtt = nodes_att, edgesAtt = edges_att, nodesVizAtt = nodes_att_viz, edgesVizAtt = edges_att_viz, defaultedgetype = "undirected", output = paste(filename,".gexf", sep=""))
