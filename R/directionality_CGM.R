...
Gibbs.dir <- function(n.iter, n.burn, suff.stat, D.gam, n.ind, sigma.a, weights.sigma, m, theta=rep(0.5, 3), dirichlet=T) {			#P(Node Label) ~ Dirichlet(theta[1], theta[2], theta[3])
