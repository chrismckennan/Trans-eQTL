...
directory.in <- '../data/cis_summary_data/braincerebellum/thresh_60'
directory.out <- '../output/cis_summary_data/braincerebellum/thresh_60'
...
if (run_gibbs) {
  ind.files.use <- (390:length(all_files))
...
```bash
perl OrganizeGibbs.pl ../data/cis_summary_data/braincerebellum/thresh_60 ../output/cis_summary_data/braincerebellum/thresh_60
```
