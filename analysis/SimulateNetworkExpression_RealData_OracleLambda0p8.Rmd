...
For these simulations, I will shrink the indirect effects by a constant $\lambda = 0.8$ and will use the Oracle value of $\lambda$ when performing the Gibbs sampling.
