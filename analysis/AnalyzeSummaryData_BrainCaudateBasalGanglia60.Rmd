...
directory.in <- '../data/cis_summary_data/braincaudatebasalganglia/thresh_60'
directory.out <- '../output/cis_summary_data/braincaudatebasalganglia/thresh_60'
...
```bash
perl OrganizeGibbs.pl ../data/cis_summary_data/braincaudatebasalganglia/thresh_60 ../output/cis_summary_data/braincaudatebasalganglia/thresh_60
```
