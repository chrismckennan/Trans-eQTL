...
## Validation and Summary of Results
Here we try to validate some of our results from real data with known trans networks

*  [Verify Results and eQTL Sharing](PreliminaryResults_VerifyANDCompare.html)
